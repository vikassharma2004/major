...
import { createOpenAIClient, healthCheck } from "./src/config/Aiconfig.js";
...
const requiredEnvVars = ["MONGO_URI", "JWT_SECRET", "JWT_REFRESH_SECRET", "PORT"];
...
const server = httpServer.listen(PORT, async () => {
  try {
    ...
    logger.info("OpenAI health check passed", { openaiOk });
